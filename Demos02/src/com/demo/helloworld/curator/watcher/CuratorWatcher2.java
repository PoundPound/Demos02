 ...
 * @Package com.demo.helloworld.curator.watcher  
 * @Description: TODO 
 * @author lewis lianfenxiang@163.com
 * @date 2017年8月20日 上午8:29:47  
 * @version V1.0    
 */
package com.demo.helloworld.curator.watcher;
			...
			public void childEvent(CuratorFramework cf, PathChildrenCacheEvent event) throws Exception
			{
				switch (event.getType())
				{
					case CHILD_ADDED:
						...
						System.out.println("CHILD_ADDED :" + new String(event.getData().getData(), "utf8"));
						break;
					case CHILD_UPDATED:
						System.out.println("CHILD_UPDATED :" + event.getData().getPath());
						System.out.println("CHILD_UPDATED :" + new String(event.getData().getData(), "utf8"));
						break;
					case CHILD_REMOVED:
						System.out.println("CHILD_REMOVED :" + event.getData().getPath());
						System.out.println("CHILD_REMOVED :" + new String(event.getData().getData(), "utf8"));
						break;
					default:
						break;
				}
