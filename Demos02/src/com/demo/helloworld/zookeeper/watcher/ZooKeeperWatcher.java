/**    
 * @Title: ZooKeeperWatcher.java  
 * @Package com.demo.helloworld.zookeeper.watcher  
 * @Description: TODO 
 * @author lewis lianfenxiang@163.com
 * @date 2017年8月20日 上午8:12:28  
 * @version V1.0    
 */
package com.demo.helloworld.zookeeper.watcher;
...
public class ZooKeeperWatcher implements Watcher
{
	...
	/** zookeeper服务器地址 */
	private static final String CONNECTION_ADDR = "192.168.31.178:2181,192.168.31.203:2181,192.168.31.204:2181";
	/** zk父路径设置 */
...
//		zkWatch.deleteAllTestPath(false);
		...
		if (zkWatch.createPath(PARENT_PATH, System.currentTimeMillis() + "", true))
		{
			...
			// ----------------第二步：读取节点/p 和 读取/p 节点下的子节点（getChildren）的区别 ----------------//
			// 读取数据
